        ...
        <div id={id} className="car">
            <div className="grid-top">
                <DropArea
                    ...
                    className="rueda-trasera-derecha"
                ></DropArea>
                <DropArea
                    wheel="front-right"
                    getState={getState}
                    setState={setState}
                    style={{ ...(getState.isOver ? insideStyle : {}) }}
                    className="rueda-delantera-derecha"
                ></DropArea>
            </div>
            <div className="grid-middle">
                <DropArea
            ...
            <div className="gird-bottom">
                <DropArea
                    ...
                    setState={setState}
                    style={{ ...(getState.isOver ? insideStyle : {}) }}
                    className="rueda-trasera-izquierda"
                ></DropArea>
                <DropArea
                    wheel="front-left"
                    getState={getState}
                    setState={setState}
                    style={{ ...(getState.isOver ? insideStyle : {}) }}
                    className="rueda-delantera-izquierda"
                ></DropArea>
            </div>
        </div>
    );
