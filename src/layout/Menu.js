...
const Card = ({itemDropped}) =>(
  ...
  <div className={`card`}>
  { itemDropped.image ? <img className="card-img-top" src={itemDropped.image} alt="Card image cap" /> :undefined}
  ...
  <div className="card-body">
    <h5 className="card-title">{itemDropped ? itemDropped.name : ''}</h5>
